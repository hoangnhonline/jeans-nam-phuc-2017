...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Hình ảnh : <a href="{{ route('product.edit', [$detail->id])}}">{{ $detail->name }}</a> - {{ $detailColor->name }}
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('product.store-image') }}">
    <div class="row">
      <!-- left column -->
