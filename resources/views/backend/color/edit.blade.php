            ...
            <div class="box-body">
              ...
              <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img src="{{ $detail->image_url ? Helper::showImage($detail->image_url ) : URL::asset('public/admin/dist/img/img.png') }}" id="thumbnail_image" class="img-thumbnail show_thumbnail" width="40" height="40">
