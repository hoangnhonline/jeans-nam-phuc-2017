...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a href="{{ route('color.create') }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
            ...
            <table class="table table-bordered" id="table-list-data">
              ...
              @if( $items->count() > 0 )
                ...
                <tr id="row-{{ $item->id }}">
                  ...
                  <td>
                    <img src="{{ Helper::showImage($item->image_url )}}" width="40" style="border:1px solid #CCC">
                  </td>
