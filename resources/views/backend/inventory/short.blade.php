...
@if(Auth::user()->email != "huongll@Nam Phúc")
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route( 'inventory.short' ) }}">Sản phẩm mới</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">        
        <div class="panel-body">
          <form class="form-inline" id="searchForm" role="form" method="GET" action="{{ route('inventory.short') }}">
          ...
          <table class="table table-bordered" id="table-list-data" style="font-size:15px">
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td>                  
                  <a style="color:#333;" href="{{ route( 'inventory.edit', [ 'id' => $item->id ]) }}">{{ $item->name }} {{ $item->name_extend }}</a> &nbsp; @if( $item->is_hot == 1 )
