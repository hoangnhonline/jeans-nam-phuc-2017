...
class SettingsController  extends Controller
{
    ...
    public function update(Request $request){
    	...
    	if($dataArr['logo'] && $dataArr['logo_name']){
            ...
            File::move(config('namphuc.upload_path').$dataArr['logo'], config('namphuc.upload_path').$destionation);
        ...
        if($dataArr['favicon'] && $dataArr['favicon_name']){
            ...
            File::move(config('namphuc.upload_path').$dataArr['favicon'], config('namphuc.upload_path').$destionation);
        ...
        if($dataArr['banner'] && $dataArr['banner_name']){
            ...
            File::move(config('namphuc.upload_path').$dataArr['banner'], config('namphuc.upload_path').$destionation);
