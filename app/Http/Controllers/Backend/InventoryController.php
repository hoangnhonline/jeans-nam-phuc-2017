...
class InventoryController extends Controller
{
    ...
    */
    ...
    public function imageOfColor(Request $request){
        ...
        $hinhArr = ProductImg::where('product_id', $product_id)->where('color_id', $color_id)->get(); 
         ...
         return view('backend.inventory.image', compact( 'detail', 'detailColor', 'hinhArr'));
    }  
    public function ajaxSearch(Request $request){    
        ...
        return view('backend.inventory.content-search', compact( 'items', 'arrSearch', 'loaiSpArr', 'cateArr', 'search_type'));
    }
    ...
    */
    public function create(Request $request)
    {
        ...
        $colorList = Color::orderBy('display_order')->get();      
        $sizeList = Size::orderBy('display_order')->get();        
        return view('backend.inventory.create', compact('loaiSpArr', 'cateList', 'parent_id', 'colorList', 'cate_id', 'sizeList', 'tagList'));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('backend.inventory.edit', compact( 'detail', 'hinhArr', 'colorList', 'sizeList' , 'loaiSpArr', 'cateArr', 'meta', 'colorSelected', 'sizeSelected', 'colorArr', 'sizeArr', 'arrInv', 'tagSelected', 'tagList'));
    }
    public function copy($id)
    {
        ...
        return view('backend.inventory.copy', compact( 'detail', 'hinhArr', 'thuocTinhArr', 'spThuocTinhArr', 'colorArr', 'loaiSpArr', 'cateArr', 'meta'));
    }
    public function ajaxDetail(Request $request)
    {       
        $id = $request->id;
        $detail = Product::find($id);
        return view('backend.inventory.ajax-detail', compact( 'detail' ));
    }
    /**
