        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                      ...
                      <div class="clearfix" style="margin-bottom:10px"></div>
                        <div class="form-group">
                          ...
                          <ul>
                            ...
                            <li class="col-md-2" style="list-style:none">
                                <label>
                                  <input type="checkbox" name="color_id[]" value="<?php echo e($color->id); ?>">
                        ...
                        <div class="form-group">
                          ...
                          <ul>
                            ...
                            <li class="col-md-2" style="list-style:none">
                                <label>
                                  <input type="checkbox" name="size_id[]" value="<?php echo e($size->id); ?>">
            ...
            <div class="box-footer">              
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('product.index')); ?>">Hủy</a>
            </div>
