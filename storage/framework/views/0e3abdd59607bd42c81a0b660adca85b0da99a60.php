...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('cate-parent.create')); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      <div class="box">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td>                  
                  ...
                  <a href="<?php echo e(route('cate-parent.thuoc-tinh', [ 'parent_id' => $item->id ])); ?>" style="float:right"><label style="cursor:pointer" class="label label-info">Thuộc tính hover</label></a>
                  <?php endif; ?>
                  <p><?php echo e($item->description); ?></p>
                </td>
                <td style="text-align:center"><a class="btn btn-info btn-sm" href="<?php echo e(route('cate.index', [$item->id])); ?>"><?php echo e($item->cates->count()); ?></a></td>               
